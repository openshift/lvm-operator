...
require (
	...
	github.com/kubernetes-csi/external-provisioner/v5 v5.3.0
	...
	github.com/topolvm/topolvm v0.0.0-00010101000000-000000000000
...
replace github.com/topolvm/topolvm => github.com/openshift/topolvm v0.15.3-0.20250902141549-bf55337a0ff7
