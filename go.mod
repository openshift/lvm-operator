...
require (
	...
	github.com/kubernetes-csi/external-resizer v1.9.3
...
replace github.com/topolvm/topolvm => github.com/openshift/topolvm v0.15.3-0.20240109105735-94fc4e2bf0f8
...
require (
	...
	github.com/cybozu-go/well v1.11.2 // indirect
