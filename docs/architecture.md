...
This document captures the high-level architecture and design rationale for LVMS (Logical Volume Manager Storage). For component diagrams and runner details, see [design/architecture.md](design/architecture.md).
...
- [Component diagram and runner table](design/architecture.md)
