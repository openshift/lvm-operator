...
- [Deploying the LVM Operator](#deploying-the-lvm-operator)
    ...
    * [Using Loop Devices](#using-loop-devices)
- [Cleanup](#cleanup)
- [Metrics](#metrics)
...
- **Kubernetes Conflicts**: As mentioned in the [Unsupported Device Types](#unsupported-device-types) section, loop devices that are already in use by Kubernetes should not be used with LVMS.
