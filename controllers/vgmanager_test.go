...
func TestVGManagerEnsureCreated(t *testing.T) {
	...
	for i, testCase := range testTable {
		...
		// todo(rohan) verify that expectedTolerations are all found in the daemonset tolerations
		// todo(rohan) verify that any nodeSelectorTerms are all found if nodeSelector is non-nil
