...
ARG LVM_MUST_GATHER=quay.io/redhat-user-workloads/logical-volume-manag-tenant/lvms-must-gather@sha256:f0a7cc70cb3ce5845a1aeec45e85487c7dd15866d2a511621f54300567a97565
WORKDIR /operator
COPY ./ ./
