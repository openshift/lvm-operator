...
ARG LVM_MUST_GATHER=quay.io/redhat-user-workloads/logical-volume-manag-tenant/lvms-must-gather@sha256:dbc643dcd1596c95d9abb8e67b5027dc077603a0ff2245d8a48c8abdedbabe59
WORKDIR /operator
COPY ./ ./
