...
ARG LVM_MUST_GATHER=quay.io/redhat-user-workloads/logical-volume-manag-tenant/lvms-must-gather@sha256:b5f14b708bfa3459b63dd754936633f8e600ccd83ec700c6cd3fc544ab15cbe7
WORKDIR /operator
COPY ./ ./
