...
konflux-task-manifest-updates:
	release/hack/update-konflux-task-refs.sh .tekton/single-arch-build-pipeline.yaml .tekton/multi-arch-build-pipeline.yaml .tekton/catalog-build-pipeline.yaml .tekton/catalog-patching-build-pipeline.yaml
...
catalog-source: opm
	$(OPM) alpha render-template semver --migrate-level=bundle-object-to-csv-metadata release/catalog/lvm-operator-catalog-template.yaml > release/catalog/lvm-operator-catalog.json
