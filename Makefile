...
performance-stress-test: ## Build and run stress tests. Requires a fully setup LVMS installation
...
performance-idle-test: ## Build and run idle tests. Requires a fully setup LVMS installation
	oc apply -f ./config/samples/lvm_v1alpha1_lvmcluster.yaml -n openshift-storage
