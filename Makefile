...
RBAC_PROXY_IMAGE ?= registry.redhat.io/openshift4/ose-kube-rbac-proxy@sha256:9b7aabfbead92df3a4afeb1854e45a92f23da52321d1705fce444510fa856145
...
ifeq (,$(wildcard $(CONTROLLER_GEN)))
	$(call go-get-tool,sigs.k8s.io/controller-tools/cmd/controller-gen@v0.13.0)
endif
...
ifeq (,$(wildcard $(ENVTEST)))
	$(call go-get-tool,sigs.k8s.io/controller-runtime/tools/setup-envtest@cb94c680f5d511d1bcc3a2c8fd0e6a23f644fb2e)
endif
...
ifeq (,$(wildcard $(GINKGO)))
	$(call go-get-tool,github.com/onsi/ginkgo/v2/ginkgo@v2.13.0)
endif
