...
ARG LVM_MUST_GATHER=quay.io/redhat-user-workloads/logical-volume-manag-tenant/lvms-must-gather@sha256:075d3e651d025919bbaa459df621ce40c5f1e440d057ba7515e436a2d981f8da
WORKDIR /operator
COPY ./ ./
